...
async function loadStatus(){const r=await apiFetch('/api/status');const j=await r.json();activeInstance=j.instance||activeInstance;updateStatus(j.status);updateMetrics(j.metrics)}
